/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a40c0230ba403b1698a4eea225346cf3)
...
declare namespace Cloudflare {
	...
	interface V4Env {
		LOADER: WorkerLoader;
		AAVE_GRAPHQL_URL: "https://api.aave.com/graphql";
		CDP_API_KEY_ID: string;
		CDP_API_KEY_SECRET: string;
		CDP_WALLET_SECRET: string;
	}
	interface Env {
		...
		CDP_WALLET_SECRET: string;
		LOADER: WorkerLoader;
		AAVE_GRAPHQL_URL?: "https://api.v3.aave.com/graphql" | "https://api.aave.com/graphql";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AAVE_GRAPHQL_URL" | "CDP_API_KEY_ID" | "CDP_API_KEY_SECRET" | "CDP_WALLET_SECRET">> {}
}

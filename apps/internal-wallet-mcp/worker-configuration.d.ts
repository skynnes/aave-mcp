/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: eacf964b62535a1f86e211facac2949b)
// Runtime types generated with workerd@1.20260217.0 2026-03-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		INTERNAL_WALLET_MASTER_KEY: "replace-with-32-byte-base64-key";
		WALLET_DEFAULT_NETWORK: "base-sepolia";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INTERNAL_WALLET_MASTER_KEY" | "WALLET_DEFAULT_NETWORK">> {}
}
